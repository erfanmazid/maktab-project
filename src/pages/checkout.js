  ...
  ${cartList
    ...
    >
      <div class="flex gap-x-4 items-center">
        ...
        >
          <i class="fa-solid ${data.icon}  text-white"></i>
        </div>
        <div class="flex flex-col justify-between w-[200px]">
          <p class="text-[20px] font-semibold">${data.type}</p>
          <p
            class="text-[14px] text-gray-400 mt-1 text-nowrap overflow-hidden text-ellipsis"
          >
            ${data.time}
      ...
      <div class="flex items-center gap-x-3">
        <p class="text-[20px] font-semibold">$${data.cash}</p>
            <i class="fa-solid fa-pen-to-square text-[20px]" onclick="shippingType()"></i>
      </div>
    </div>
    ...
    <div class="mt-5 flex flex-col gap-y-5">
      ...
      <div class="bg-white p-6 flex flex-col gap-y-7 rounded-[20px]">
        ...
        >
          <p class="text-gray-400">Shipping</p>
          <p class="font-semibold">$${data.cash}.00</p>
        </div>
        <div class="flex justify-between items-center">
          <p class="text-gray-400">Total</p>
