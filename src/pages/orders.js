...
function renderHtml(carts) {
  document.querySelector("#app").innerHTML = `
    ...
    <div class="flex justify-between items-center w-[380px] py-4">
        ...
        <div class="w-[50%] text-center border-b pb-2 border-black orderDisable click" style="border-width:0px 0px 3px 0px">
            <p>Completed</p>
        </div>
    </div>
      <div
...
function click() {
  ...
  bars.forEach((items) => {
    items.addEventListener("click", () => {
      ...
      console.log(items.querySelector("p").innerHTML);
    });
  });
}
